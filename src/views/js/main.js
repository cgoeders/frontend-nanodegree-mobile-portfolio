...
var resizePizzas = function(size) { 
  ...
  // change the value for the size of the pizza above the slider
...
// create and append all pizzas when page loads
for (var i = 2; i < 100; i++) {
  var pizzasDiv = document.getElementById("randomPizzas");
  pizzasDiv.appendChild(pizzaElementGenerator(i));
}

// User Timing API again; these measurements indicate how long it takes to generate the initial pizzas
...
// log the average amount of time per 10 frames needed to move sliding background pizzas on scroll
...
// move sliding background pizzas based on scroll position
